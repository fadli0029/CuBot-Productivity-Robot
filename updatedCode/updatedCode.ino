...
#define happyMoodV2 2
#define happyMoodV3 3
#define stayStill 4
...
/*************************************************** 
  ...
  rotation: how much the servo should rotate
  returnPos: should be set to 0
  speed_dps: speed of rotation, in degree per sec
***************************************************/
